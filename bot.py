...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_type == "private" and worker is None:
        await update.message.reply_text(
            "👋 Добро пожаловать!\n\n"
            "Этот бот предназначен для проверки Ваших видео-статусов и факта выполненных работ.\n\n"
            "С помощью этого бота Вы будете:\n"
            "• получать напоминания о времени сдачи отчёта;\n"
            "• отправлять видео-статусы;\n"
            "• отправлять видео с фактом выполненных работ;\n"
            "• получать результаты проверки.\n\n"
            "Для начала необходимо пройти регистрацию.\n"
            "Не переживайте — это займёт не больше одной минуты.\n\n"
            "Нажмите кнопку «🔑 Начать регистрацию» внизу экрана, чтобы продолжить.",
