...
async def send_report_instruction(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Ровно в 10:00, 12:00, 15:00, 17:00 вам необходимо отправлять видео-статус в этот чат.\n\n"
        "Статус состоит из:\n"
        "1) Формат:\n"
        "Только видеозапись с голосовым объяснением.\n"
        "2) Содержание видео-статуса:\n\n"
        "Вам необходимо указать:\n\n"
        "что вы выполнили за последние 2 часа;\n"
        ...
        "и результат.\n\n"
        "Пример:\n\n"
        "«За последние 2 часа я копал 15 метром траншеи. Показать в кадре результат работы».\n\n"
        "Важно: вечером в 17:00 вам необходимо отправить 2 видео\n"
        "1. Видео-статус за последние 2 часа\n\n"
        "В видео необходимо показать и обозначить голосом что было сделано за последние 2 часа\n\n"
